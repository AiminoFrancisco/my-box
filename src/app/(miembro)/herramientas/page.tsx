...
export const metadata = { title: "Herramientas · My Borrow Box" };
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-tenue">
          Saca hasta {CONFIG_DEFECTO.max_herramientas} a la vez. Llevas {nActivos} activas.
        </p>
      </div>
          ...
          return (
            <article key={h.id} className="overflow-hidden rounded-2xl border border-borde bg-superficie shadow-suave">
              ...
              <div className="p-3 sm:p-4">
                ...
                <p className="mt-0.5 text-[11px] text-tenue sm:text-xs">Reemplazo: {formatoDinero(h.valor_reemplazo)}</p>
                ...
                <div className="mt-3 flex justify-end">
                  {activo && disponible ? (
                    ...
                    <span className="text-[11px] text-tenue sm:text-xs">
                      {!activo ? "Activa membresía" : "No disponible"}
                    </span>
                  )}
                </div>
              </div>
